...
const CreateRequestPage = () => {
  ...
  const handleSubmit = () => {
    ...
    axios.post('http://127.0.0.1:8000/request/create/', requestData)
      .then(response => {
        // Handle the response
        console.log('Request submitted successfully:', response.data);
        // Redirect to the history page or perform any other action
        navigate('/history');
      })
      .catch(error => {
        // Handle any errors
...
<>
   <Navbar/>
    ...
    <div className="create-request-containervvvv">
